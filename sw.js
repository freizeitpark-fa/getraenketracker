const CACHE='getraenketracker-v31-0-1';
const ASSETS=['./','./index.html','index.html','style.css','app.js','manifest.json','CHANGELOG.md','data/barkarte.json','data/pakete.json','icons/icon-192.png','icons/icon-512.png'];
